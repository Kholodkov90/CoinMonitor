...
import com.kholodkov.coinmonitor.core.common.toDisplayStringFloored
...
fun WeekStats.toStatisticItem(currency: Currency) =
    StatisticItem(
...
fun MonthStats.toStatisticItem(currency: Currency) =
    StatisticItem(
...
fun YearStats.toStatisticItem(currency: Currency) =
    StatisticItem(
